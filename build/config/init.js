...
module.exports = function () {
  ...
  _puppyModel2.default.remove({}, function (err) {
    if (err) throw err;
  });
  ...
  // puppy 02
  puppy = new _puppyModel2.default();
  ...
  _questionModel2.default.remove({}, function (err) {
    if (err) throw err;
  });

  // question01
  var question = new _questionModel2.default();
  ...
  // question02
  question = new _questionModel2.default();
