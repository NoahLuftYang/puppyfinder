...
function dbManagerController($http, $window, $timeout) {
  ...
  _this.select = function (breed) {
    ...
    $http.get("/puppies/" + breed).success(function (response) {
  ...
  function update(puppy) {
    $http.put("/puppies/" + _this.puppy._id, puppy).success(function (response) {
  ...
  function add(puppy) {
    $http.post("/result", puppy).success(function (response) {
  ...
  function del(breed) {
    $http.delete("/puppies/" + breed).success(function (response) {
  ...
  function reloadPage() {
    $http.get("/puppies").success(function (response) {
      _this.puppies = response;
    });
  }
